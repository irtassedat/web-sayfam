...
import { useTheme } from "../context/LanguageContext";
...
function Footer() {
  ...
  return (
    <div className="bg-white dark:bg-myDarkG dark:text-white flex flex-col items-center pt-24 pb-6 lg:justify-center lg:flex-row">
