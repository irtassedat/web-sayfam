    ...
    <>
      <div className="container mx-auto bg-header dark:bg-myDarkC">
        ...
        <div className="flex flex-wrap flex-col-reverse w-full mx-auto gap-10 lg:flex-row lg:flex-nowrap lg:max-w-6xl lg:pt-[151px] lg:pb-[94px] lg:w-9/12">
          ...
          <img
            className="profile-image animated-border mt-20 w-48 h-48 mx-auto object-cover rounded-[32px] shadow-[-20px_-20px_rgba(233,37,119,1)] lg:w-[341px] lg:h-[341px] lg:mt-9 lg:mx-0 lg:mr-8"
        ...
        <div className="relative">
          <img
            className="hidden md:block absolute right-0 bottom-40 transform -translate-y-1/2"
