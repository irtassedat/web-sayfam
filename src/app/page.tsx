        ...
        <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }}>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div className="space-y-4 text-sm text-muted leading-relaxed">
              ...
              <a href="/cv" className="inline-flex items-center gap-2 mt-2 px-4 py-2 rounded-lg glass text-xs text-muted hover:text-primary hover:border-primary/30 transition-all group">
                ...
                View Resume
                <svg className="w-3 h-3 opacity-0 group-hover:opacity-100 transition-opacity" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M9 5l7 7-7 7" /></svg>
              </a>
            </div>
